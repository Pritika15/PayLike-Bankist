...
//   const inputClosePin = document.querySelector('.form__input--pin');
  ...
  //   const interest=acc.movements.filter(mov=> mov>0).map(deposits=>(deposits*acc.interestRate)/100)
  ...
  // const withdrawalss=movements.filter(function(mov){return mov<0;});
